...
void test_strategy_sort_by_amount_descending() {
    ...
    auto by_amount = [](const Expense& e1, const Expense& e2) {
...
void test_decorator_summary_adds_total() {
    ...
    assert(output.find("21.7") != std::string::npos);
}
...
void test_integration_export_sorted_expenses() {
    ...
    AuditedExporter<SummaryExporter<CsvExporter>> exporter{
...
int main() {
    ...
    std::cout << "Todos los test se pasaron!\n";
    return 0;
}